...
function initialize() {
	...
	$
			.getJSON(
					"../landblock/site/" + id + "/trails/yield",
...
//	};
	//(i);
	var infoWindow ;
	var url = encodeURI('../yieldprediction/block/' + data.id + '/cropType');
...
//					});
	var content = "<div style='font-size:12px'>地块编号: " + data.blockNumber+"<br>地块面积(亩):"+data.area
									+ "<br>地块类型: "
										...
										+"<a href='../yieldprediction/charts?type=1&blockId="+ data.id+ "&cropTypeId="+data.cropTypeId+ "' target='_blank'>查看产量预测一览图</a><br>"
