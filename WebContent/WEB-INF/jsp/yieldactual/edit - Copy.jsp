...
<script type="text/javascript" src="../js/ahover.js"></script>
	...
	<script>
	  $(function() {
		...
		$("#actualYield").prop('disabled', true);
		$("#actualYield").prop('readonly', true);
		$("input[name='radio']").click(function(){
			if($("input[name='radio']:checked").val() == "1"){
				$("#predictYield").prop('disabled', true);
				$("#predictYield").prop('readonly', true);
				$("#actualYield").prop('disabled', false);
				$("#actualYield").prop('readonly', false)
			}else{
				$("#predictYield").prop('disabled', false);
				$("#predictYield").prop('readonly', false);
				$("#actualYield").prop('disabled', true);
				$("#actualYield").prop('readonly', true)
			}
		});
			...
			<form name="form1" id="form1" action="./save" method="post">
				...
				<div class="userinfolist">
					...
					<div class="new_item">
						...
						<div class="bdmain">
							<div id="radio">
								<input type="radio" id="radio1" name="radio" checked="checked" value="0"><label for="radio1">预测产量</label>
								<input type="radio" id="radio2" name="radio" value="1"><label for="radio2">实际产量</label>								
							</div>
						</div>
					</div>
					<div class="new_item">
						...
						<div class="bdmain">
							...
							<label onmouseout="this.className='input_out'"
								...
								class="input_out"> <input type="text" id="predictTime"
								name="predictTime" value="${currentObj.predictTime }"></label>
					...
					<div class="new_item">
						...
						<div class="bdmain">
							...
							<label onmouseout="this.className='input_out'"
								...
								name="predictYield" value="${currentObj.predictYield }"></label>
