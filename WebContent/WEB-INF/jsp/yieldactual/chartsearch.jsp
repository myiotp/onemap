...
<body>
	...
	<div class="page">
		...
		<div class="container">
			<div class="connav">
				» <a href="./list">产量预测图表</a> &gt; 查询
			</div>
			<!--  主体   start -->

			<form name="form1" id="form1" action="./charts" method="post">
				...
				<div class="userinfolist">
					...
					<c:import url="../common/selectlandblock.jsp">
						<c:param name="blockNumber" value="${currentObj.id}"></c:param>
					</c:import>
					<c:import url="../common/selectcroptype.jsp">
						<c:param name="cropType" value="${currentObj.id}"></c:param>
					</c:import>
				</div>
