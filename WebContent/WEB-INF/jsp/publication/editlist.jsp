...
<div class="topselect">
	...
	<shiro:hasAnyRoles name="admin"> <input type="button" value="新建" id="newBtn" class="subglobal sub1"/>
	</shiro:hasAnyRoles>
	</form>
...
<div id="dialog-showTrail" title="报告内容">
	<div class="content_nr">
        <br/><br/><br/>
        <div class="ny_main">
          <div class="new_biaoti">
               <font style="font-size:20px;"><div id="title"></div></font>
			   <hr>
          </div>
          <!--<div class="new_time">  
              本信息于<div id="time"></div>发布 (出处:<div id="source"></div>),
               共<div id="readamount"></div>次访问</div>-->
         <div id="content"></div>        
        </div>
    </div>
</div>
...
<script src="../js/app/publication/script.js"></script>
