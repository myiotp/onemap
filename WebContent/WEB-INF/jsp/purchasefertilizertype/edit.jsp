...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">投入肥料管理</a> &gt; 新建   	</div>
		    	<!--  主体   start -->
...
<c:otherwise>修改</c:otherwise></c:choose>投入肥料记录</span></h3>
	 <c:import url="../common/selectfertilizertype.jsp">
	   <c:param name="fertilizerTypeId" value="${currentObj.fertilizerTypeId}"></c:param>
	   </c:import>
