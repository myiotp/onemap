...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">农药类型管理</a> &gt; 新建农药类型    	</div>
		    	<!--  主体   start -->
...
<c:otherwise>修改</c:otherwise></c:choose>农药类型信息</span></h3>
     <div class="new_item">
		<div class="tit"><em>*</em>农药类型：</div>
		<div class="bdmain">
			...
			<label onmouseout="this.className='input_out'" onmousemove="this.className='input_move'" onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" onfocus="this.className='input_on';this.onmouseout=''" class="input_out">
				<input type="text" id="pesticideType" name="pesticideType" value="${currentObj.pesticideType }">
			</label>
			
		</div><div class="new_plus"><span id="pesticideTypeTip"></span></div>
    </div>
     <div class="new_item">
...
$(document).ready(function() {
	...
	$("#pesticideType").formValidator({
		tipID:"pesticideTypeTip",
		onShow:"",
		onFocus:"",
		onCorrect:""
	}).inputValidator({
