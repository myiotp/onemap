...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">农药类型管理</a> &gt; 农药类型列表    	</div>
		    	<!--  主体   start -->
<div class="topselect">
							        ...
							        <div loading-container="tableParams.settings().$loading">
							            <table ng-table="tableParams" template-pagination="custom/pager" show-filter="true" class="table" style="border-collapse: collapse">
							                <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
							                	<td data-title="'农药类型'" filter="{ 'pesticideType': 'text' }"  sortable="'pesticideType'">
							                        {{obj.pesticideType}}
							                    </td>
...
<script src="../js/app/pesticidetype/script.js"></script>
