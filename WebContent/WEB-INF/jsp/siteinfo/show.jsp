			...
			<div id="container" style="min-width: 800px;">
				<div class="userinfolist">
					<div class="new_item">
						...
						<div class="bdmain">${currentObj.cooperativeName }</div>
						<div class="new_plus">
					...
					<div class="new_item">
						...
						<div class="bdmain">${currentObj.owner }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>性质：
						</div>
						<div class="bdmain">${currentObj.character }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>规模：
						</div>
						<div class="bdmain">${currentObj.size }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>地址：
						</div>
						<div class="bdmain">${currentObj.address }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>网址：
						</div>
						<div class="bdmain">${currentObj.website }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>法定代表人：
						</div>
						<div class="bdmain">${currentObj.legalperson }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>联系电话：
						</div>
						<div class="bdmain">${currentObj.telephone }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>电子邮箱：
						</div>
						<div class="bdmain">${currentObj.email }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>QQ：
						</div>
						<div class="bdmain">${currentObj.qq }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>微信：
						</div>
						<div class="bdmain">${currentObj.wechat }</div>
						<div class="new_plus">
					...
					<div class="new_item">
						...
						<div class="bdmain">${currentObj.gpsx }</div>
						<div class="new_plus">
					...
					<div class="new_item">
						...
						<div class="bdmain">${currentObj.gpsy }</div>
						<div class="new_plus">
					...
					<div class="new_item">
						...
						<div class="bdmain">${currentObj.memo }</div>
						<div class="new_plus">
					...
					<div class="new_item">
						...
						<div class="bdmain">${currentObj.collector }</div>
					</div>
					<div class="new_item">
						<div class="tit">
							<em></em>采集时间：
						...
						<div class="bdmain">
							...
							<fmt:formatDate value="${currentObj.collecttime }" type="date"
								pattern="yyyy/MM/dd" />
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<c:forEach items="${resultList}" var="obj" varStatus="varStatus">
								...
								<tr onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
									<!-- <td >${site.id}</td> -->
									<td>${obj.certtype}</td>
									<td><fmt:formatDate value="${obj.certtime}"
											pattern="yyyy年MM月dd日" /></td>
									<td>${obj.validtime}</td>
									<td>${obj.certorganization}</td>
									<td>${obj.certnumber}</td>
									<td><a title="详细" class="getglobal icoglobal" href="#"
										onclick="showDialog(${obj.id })"></a></td>
							...
							<c:forEach items="${resultList2}" var="obj" varStatus="varStatus">
								...
								<tr onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
									...
									<td data-title="'定位'"><a title="定位"
										class="getglobal icoglobal" href="../farmmachinery/chartsear?licensenumber=${obj.licensenumber}"
										target="_blank"></a></td>	
