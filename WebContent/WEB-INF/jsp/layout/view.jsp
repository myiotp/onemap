                        ...
                        <table id="con_huoyuan_1" width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="bghui" width="8%">货物名称</td>
                                    <td class="bghui" width="10%">货物重量(吨)</td>
                                    <td class="bghui" width="8%">车型要求 </td>
                                    <td class="bghui" width="8%">车长要求 </td>
                                    <td class="bghui" width="8%">期望运价</td>
                                    <td class="bghui" width="8%">发货时间</td>
                                    <td class="bghui" width="10%">联系方式</td>
                                    <td class="bghui" width="5%">公里数</td>
                                </tr>
                            </tbody>
                        </table>
