...
<div class="page">
	...
	<c:param name="memuid" value="7"></c:param>
	<c:param name="a" value="7"></c:param>
	</c:import>
<!-- 列表内容 begin -->
	<div class="container">
							        ...
							        <div loading-container="tableParams.settings().$loading">
							            <table ng-table="tableParams" template-pagination="custom/pager" show-filter="true" class="table" style="border-collapse: collapse">
							                <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
                                                ...
                                                <td data-title="'货物名称'"   sortable="'cargo_name'">
                                                    {{obj.cargoName}}
                                                </td>
                                                <td data-title="'货物重量(吨)'"   sortable="'cargo_weight'">
                                                    {{obj.cargoWeight}}
                                                </td>
                                                <td data-title="'车型要求'"   sortable="'car_type'">
                                                    {{obj.carType}}
                                                </td>
                                                <td data-title="'车长要求'"  sortable="'car_length'">
                                                    {{obj.carLength}}
                                                </td>
                                                <td data-title="'期望运价'"  sortable="'price'">
                                                    {{obj.price}}
                                                </td>
                                                <td data-title="'发货时间'"   sortable="'ship_timestamp'">
                                                    {{obj.shipTimestamp}}
                                                </td>
                                                <td data-title="'联系方式'"  >
                                                    {{obj.ownerCellphone}}
...
<script src="../js/app/cargo/script.js"></script>
