...
$(function(){
	...
	<c:param name="memuid" value="4"></c:param></c:import>
	<span class="blank18"></span>
<div class="page">
	<c:import url="../common/left.jsp">
	<c:param name="memuid" value="4"></c:param>
	<c:param name="a" value="4"></c:param>
	</c:import>
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">车辆年检告警管理</a> &gt; 列表    	</div>
		    	<!--  主体   start -->
<div class="topselect">
							        ...
							        <div loading-container="tableParams.settings().$loading">
							            <table ng-table="tableParams" template-pagination="custom/pager" show-filter="false" class="table" style="border-collapse: collapse">
							                <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
                                                    ...
                                                    <td data-title="'年检时间'" >
                                                        <div ng-if="obj.authresult <=30"><font color=red style="font-size:12px">{{obj.checkdeadline}}</font></div>
                                                        <div ng-if="obj.authresult >30">{{obj.checkdeadline}}</div>
                                                    </td>
                                                    <td data-title="'到期天数'" >
