...
<c:otherwise>修改</c:otherwise></c:choose>库区信息</span></h3>
     <div class="new_item">
   ...
   <c:param name="siteId" value="${currentObj.warehouse.siteId}"></c:param>
   </c:import>
     <c:import url="../common/selectwarehouse.jsp">
   <c:param name="warehouseId" value="${currentObj.warehouseId}"></c:param>
   </c:import>
     <c:import url="../common/selectfloor.jsp">
   <c:param name="floor" value="${currentObj.floor}"></c:param>
   </c:import>
