...
<body>
	...
	<div class="page">
		...
		<div class="container">
			<div class="connav">
				» <a href="./editlist">产量预测表管理</a> &gt; 产量预测表列表
			</div>
			<!--  主体   start -->
			<div class="topselect">
			...
			<div class="conborder getcode">
				<div class="onlinelist">
					<div ng-app="main">
							<div id="TableCtrl" ng-controller="TableCtrl">
							        ...
							        <div>
							            <table ng-table="tableParams" template-pagination="custom/pager" show-filter="true" class="table" style="border-collapse: collapse">
							                <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
							                    ...
							                    <td data-title="'预测时间'" filter="{ 'predictTime': 'text' }" sortable="'predictTime'">
							                       {{obj.predictTime| date:'yyyy-MM-dd'}}
							                    </td>
							                    <td data-title="'预测产量'" filter="{ 'predictYield': 'text' }" sortable="'predictYield'">
							                        {{obj.predictYield}}
							                    </td>
...
<script type="text/javascript">	
	...
	var dialog22 = $("#dialog-Delete").dialog({
		...
		buttons: [{
				...
				click: function (){
					...
					var scope = angular.element($("#TableCtrl")).scope();					
	...
	<script src="../js/app/yieldprediction/script.js"></script>
