...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./list">仓库管理</a> &gt; 仓库列表    	</div>
		    	<!--  主体   start -->
<div class="topselect">
	<form method="get" action="?" id="form1" name="form1"><p  class="domain">
	 仓库名称：<input type="text" class="textinput" id="name" name="name" style="width:90px" value="${warehouse.name}"/></p>
...
<c:choose>
<c:when test="${!empty resultList}">共计仓库数量：${totalCount}</c:when>
<c:otherwise>暂无仓库！</c:otherwise> </c:choose>
</p></h2>
