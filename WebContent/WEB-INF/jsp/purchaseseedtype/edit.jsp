...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">行驶证认证审核管理</a> &gt; 新建   	</div>
		    	<!--  主体   start -->
...
<c:otherwise>修改</c:otherwise></c:choose>行驶证认证审核记录</span></h3>
	 <c:import url="../common/selectseedtype.jsp">
	   <c:param name="seedTypeId" value="${currentObj.seedTypeId}"></c:param>
	   </c:import>
