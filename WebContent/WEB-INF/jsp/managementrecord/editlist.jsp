...
<body>
                                    ...
                                    <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
                                        ...
                                        <td data-title="'签字'">
                                            <div ng-if="obj.approvelevel == 0">
                                                <a title="提交副经理经理签字审批" class=""  href="#" ng-click="submit4approveDialog(obj.id,4)">提交审批</a><br/>
                                            </div>
                                            <div ng-if="obj.approvelevel == 4">
                                                <a title="副经理签字" class="" href="#" ng-click="approveDialog(obj.id,5)">副经理</a><br/>
                                            </div>
                                            <div ng-if="obj.approvelevel == 5">
                                                <a title="经理签字" class="" href="#" ng-click="approveDialog(obj.id,6)">经理</a><br/>
                                            </div>
                                        ...
                                        <td data-title="'回程单'"  style="width:80px">
                                            <a title="补录" class="" href="./edit?id={{obj.id }}">补录回程单</a><br/>
                                            <a title="查看下载" class="" href="/reportsm5e0mw4efes0sd8kf2nz/servlets/html?url={{obj.id}}" target="_blank">查看</a><br/>
                                            <a title="查看下载" class="" href="/reportsm5e0mw4efes0sd8kf2nz/servlets/html?url={{obj.id}}" target="_blank">下载pdf</a> 
                                        </td>
                                        <%} %>
                                    </tr>
                                </table>
    ...
    <c:import url="../common/footer3.jsp"></c:import>
    <div id="dialog-approve" title="签字">
	    <form id="approveForm" name="approveForm" method="post" action="./approve">
	            请输入签字名：<br/>
	...
	<div id="dialog-submit4approve" title="提交签字审批">
        <form id="approveForm2" name="approveForm2" method="get" action="./submit4approve">
                确定提交签字审批吗?
...
<script src="../js/app/managementrecord/script4approvelist.js"></script>
