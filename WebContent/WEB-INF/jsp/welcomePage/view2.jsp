...
<script type="text/javascript" src="../js/map/RemoteMap.js"></script>	
...
function initialize(){
	...
	$(".remotesense").height($(window).height()-100);
...
<body onload='initialize()'>
	...
	<div>
		...
		<div id="remotesensediv" class="remotesensediv">			
			<div id="remotesense" class="remotesense"></div>
			<img class="maplegend" src = "../images/maplegend.png"></img>
		</div>
		
		<div id="machinemap" class="map machinemap"></div>
		<div id="navigationbar" class="navbar-fixed-top1 filter filterbg">
