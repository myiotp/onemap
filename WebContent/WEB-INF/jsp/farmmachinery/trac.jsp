							...
							<div loading-container="tableParams.settings().$loading">
								<table ng-table="tableParams" template-pagination="custom/pager"
									...
									<tr ng-repeat="obj in $data" onmouseout="Kkdown(this);"
										...
										<td data-title="'近一周'"><a title="查看近一周的轨迹回放"
											class="getglobal icoglobal" href="./tra?t=7&licensenumber={{obj.licensenumber|escape}}"
											target="_blank"></a></td>
										<td data-title="'一个月'"><a title="查看一个月的轨迹回放"
											class="getglobal icoglobal" href="./tra?t=30&licensenumber={{obj.licensenumber|escape}}"
											target="_blank"></a></td>
										<td data-title="'六个月'"><a title="查看六个月的轨迹回放"
											class="getglobal icoglobal" href="./tra?t=180&licensenumber={{obj.licensenumber|escape}}"
											target="_blank"></a></td>		
