...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">实名认证审核管理</a> &gt; 列表    	</div>
		    	<!--  主体   start -->
<div class="topselect">
							        ...
							        <div loading-container="tableParams.settings().$loading">
							            <table ng-table="tableParams" template-pagination="custom/pager" show-filter="false" class="table" style="border-collapse: collapse">
							                <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
							                	    <td data-title="'用户名'" >
                                                    <a href="./views?username={{obj.username}}" target="_blank">{{obj.username}}</a>
                                                </td>
							                	    <td data-title="'手持身份证正面照'" >
							                        <a title="查看" class="getglobal icoglobal" href ="#" ng-click="showDetailDialog(obj.image101)"></a>
							                    </td>
							                    <td data-title="'身份证反面照'" >
							                        <a title="查看" class="getglobal icoglobal" href ="#" ng-click="showDetailDialog(obj.image102)"></a>
							                    </td>
												<td data-title="'营业执照'">
							                       <a title="查看" class="getglobal icoglobal" href ="#" ng-click="showDetailDialog(obj.image103)"></a>
							                    </td>
							                    <td data-title="'法人证'">
							                        <a title="查看" class="getglobal icoglobal" href ="#" ng-click="showDetailDialog(obj.image104)"></a>
							                    </td>
...
<script src="../js/app/purchasepesticidetype/script.js"></script>
