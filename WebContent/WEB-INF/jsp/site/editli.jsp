...
<c:otherwise>暂无地块！</c:otherwise> </c:choose>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
        <tr>
    			...
    			<td ><a title="详细" class="getglobal icoglobal" href ="#" onclick="showDetailDialog2(${result.id })"></a></td>
...
<script type="text/javascript">
	...
	function showDetailDialog2(id) {
		var url = encodeURI('../landblock/id/' + id);
