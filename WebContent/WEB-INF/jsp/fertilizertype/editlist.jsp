...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">肥料类型管理</a> &gt; 肥料类型列表    	</div>
		    	<!--  主体   start -->
<div class="topselect">
							        ...
							        <div loading-container="tableParams.settings().$loading">
							            <table ng-table="tableParams" template-pagination="custom/pager" show-filter="true" class="table" style="border-collapse: collapse">
							                <tr ng-repeat="obj in $data" onmouseout="Kkdown(this);" onmouseover="Kkover(this);">
							                	<td data-title="'肥料类型'" filter="{ 'fertilizerType': 'text' }"  sortable="'fertilizerType'">
							                        {{obj.fertilizerType}}
							                    </td>
...
<script src="../js/app/fertilizertype/script.js"></script>
