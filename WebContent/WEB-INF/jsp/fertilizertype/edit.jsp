...
<!-- 列表内容 begin -->
	<div class="container">
		    	<div class="connav">
			       		» <a href="./editlist">肥料类型管理</a> &gt; 新建肥料类型    	</div>
		    	<!--  主体   start -->
...
<c:otherwise>修改</c:otherwise></c:choose>肥料类型信息</span></h3>
     <div class="new_item">
		<div class="tit"><em>*</em>肥料类型：</div>
		<div class="bdmain">
			...
			<label onmouseout="this.className='input_out'" onmousemove="this.className='input_move'" onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" onfocus="this.className='input_on';this.onmouseout=''" class="input_out">
				<input type="text" id="fertilizerType" name="fertilizerType" value="${currentObj.fertilizerType }">
			</label>
			
		</div><div class="new_plus"><span id="fertilizerTypeTip"></span></div>
    </div>
     <div class="new_item">
		...
		<div class="bdmain">
			...
			<label onmouseout="this.className='input_out'" onmousemove="this.className='input_move'" onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" onfocus="this.className='input_on';this.onmouseout=''" class="input_out">
				<input type="text" id="description" name="description" value="${currentObj.description }">
			</label>
			
		</div><div class="new_plus"><span id="descriptionTip"></span></div>
    </div>
...
$(document).ready(function() {
	...
	$("#fertilizerType").formValidator({
		tipID:"fertilizerTypeTip",
		onShow:"",
		onFocus:"",
		onCorrect:""
	}).inputValidator({
