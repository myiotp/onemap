...
<c:otherwise>暂无记录！</c:otherwise> </c:choose>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
        <tr>
    			...
    			<td ><a href="#" onclick="showDialog(${result.cooperativeId},'${result.operationTime}')" id="showTrail_link">查看轨迹</a>&nbsp;<%if(isAdmin){%>|&nbsp;<a href="#" onclick="openDialog(${result.id })" id="manageTrail_link">导入轨迹</a><%} %>
    			</td>    
    			<%if(isAdmin){%>			
    			<td width=100>
