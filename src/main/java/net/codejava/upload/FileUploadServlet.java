...
import com.onemap.service.impl.BlockXYServiceImpl;
...
//		t.setBlockId("001");
//		t.setPositionSequence(1);
//		Double positionX = new Double(10.20);
//		Double positionY = new Double(10.20);
//		t.setPositionX(positionX);
//		t.setPositionY(positionY);
//		try {
//			service = new BlockXYServiceImpl();
//			service.save(t);
//		} catch (Exception e) {
...
//		getServletContext().getRequestDispatcher("/landblock/editlist?page="+p).forward(
//				request, response);
	}
}