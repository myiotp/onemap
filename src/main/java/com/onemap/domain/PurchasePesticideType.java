 ...
 *
 */
public class PurchasePesticideType  extends BaseModel{
	...
	private Integer id;
	private Integer pesticideTypeId, cooperativeId;
	private Date purchaseTime;
	private Double purchaseAmount;
	private String pesticideType, name,serialNumber,level,producer,producerTel,seller,sellerTel,brief,purchaser;
