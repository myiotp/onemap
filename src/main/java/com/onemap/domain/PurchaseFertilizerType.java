 ...
 *
 */
public class PurchaseFertilizerType  extends BaseModel{
	...
	private Integer id;
	private Integer fertilizerTypeId, cooperativeId;
	private Date purchaseTime;
	private Double purchaseAmount;
	private String fertilizerType, name,serialNumber,level,producer,producerTel,seller,sellerTel,brief,purchaser;
