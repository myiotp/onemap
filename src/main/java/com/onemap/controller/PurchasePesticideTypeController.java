...
@Controller
@RequestMapping("/purchasepesticidetype")
public class PurchasePesticideTypeController extends BaseController<IdentityAuth, Integer> {
	@Autowired
	...
	public ModelAndView show(User t) throws Exception {
		...
		int usertype = tInDb.getUsertype();
		if(usertype == 2) {
			tInDb.setPassword("企业");
		}else {
			tInDb.setPassword("个人");
		}
