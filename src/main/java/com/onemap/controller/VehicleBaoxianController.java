...
@Controller
@RequestMapping("/vehiclebaoxian")
public class VehicleBaoxianController extends BaseController<UserVehicle, Integer> {
	@Autowired
	...
	public NGTableObject<UserVehicle> ngtable(UserVehicle t, HttpServletRequest request)
		...
		t.setOrder("asc");
		t.setOrderBy("insurancedeadline");
		...
		for (UserVehicle v : tList) {
			Date checkdeadline = v.getInsurancedeadline();
