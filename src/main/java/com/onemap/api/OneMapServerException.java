/**
 * @(#)ServerException.java, 2012-12-11. 
 * 
 ...
 *
 */
public abstract class OneMapServerException extends OneMapException {
     ...
     * @param errorCode
     */
    public OneMapServerException(String errorType, String errorCode) {
